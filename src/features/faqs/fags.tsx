...
export function PetAdoptionFAQ() {
  return (
    <div className="mx-auto py-14 bg-gray-50">
      <div className="container mx-auto px-20">
        <div className="text-center mb-12">
          <p className="text-blue-500 text-sm mb-2">
            Answers to common questions to help you find your new best friend.
          </p>
          <h1 className="text-3xl font-bold text-gray-800">
            Frequently Asked Questions
          </h1>
        </div>
        <div className="space-y-4 bg-white px-6 py-3 rounded-md">
